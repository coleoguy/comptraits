...
# P1, P2, F1, rF1, BC1, rBC1, BC2, rBC2
...
blank <- read.csv("../data/more.cohort.cross.structure.csv")

# get the generating c-matrix for the increased number of cohorts
cmat <- read.csv("../data/sim data/more.cohort.gen.cmat.csv")[,-1]
replicate <- 1000
